...
const Page = () => {
  ...
  return (
    <div className="continer mx-auto">
      ...
      <div className=" max-w-2xl bg-gray-100 mx-auto flex rounded-md border border-gray-400 p-4 my-4">
        <input 
        type="text" 
      ...
      <ul className="max-w-2xl mx-auto">
        {
          list.map(item => (
            <li 
              ...
              <button onClick={() => handleEdit(item.id)} className="mx-4 text-black hover:text-gray-400">Editar</button>
              <button onClick={() => handleRemove(item.id)} className="mx-4  text-black hover:text-gray-400">Excluir</button>
              </li>
          ))
        }
      </ul>
